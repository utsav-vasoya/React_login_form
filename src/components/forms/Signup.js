...
const Signup = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (signup.email && !validator.isEmail(signup.email)) {
            ...
            axios.post("https://react-form-backend.onrender.com/users/register", { name: signup.name, email: signup.email, password: signup.password, confirmPassword: signup.confirmPassword }).then((res) => {
                if (res.data.msg) {
